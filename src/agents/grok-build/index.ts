 ...
 * shelling out to `grok --version` is a cross-platform hazard for no gain, and
 * ccset can write this config before Grok Build has ever run. Any one of the
 * agent directory, config.toml or auth.json counts as detection -- credentials
