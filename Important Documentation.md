...
### 9.44 Grok Build agent integration (2026-09-14)

ccset now supports a fifth Agent, Grok Build (xAI's coding agent, `grok`).
...
### 9.45 OCR review fixes: 42 findings from the full-repo audit (2026-09-15)
