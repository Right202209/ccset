...
export const DOC_ENTRIES: readonly DocEntry[] = [
  ...
  },
  {
    ...
    sources: { en: 'docs/milestone-3-non-interactive.md' },
  },
  {
    slug: 'glossary',
    repoPath: 'CONTEXT.md',
  ...
  },
  {
    ...
    sources: { en: 'docs/verification.md' },
  },
  {
    ...
    sources: { en: 'docs/adding-an-agent.md' },
  },
  {
